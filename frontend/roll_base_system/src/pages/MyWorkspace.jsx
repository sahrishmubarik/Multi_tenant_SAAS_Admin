...
export default function MyWorkspace() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch(`/api/v1/workspace/${workspaceId}`, {
        method: "PATCH",
        headers: {
  ...
  async function confirmLeaveWorkspace() {
    ...
    try {
      const response = await fetch(`/api/v1/workspace/leave/${workspaceId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  //         <p className="text-sm text-[#66686d]">
  //           Loading workspace...
  //         </p>
  //       </div>
  //     </main>
                  ...
                  >
                    <div className="mb-5">
                      ...
                      <p className="mt-3 text-sm leading-6 text-[#252629]">
                        The selected admin will become the new owner, and you
